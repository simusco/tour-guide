 ...
 */
package com.moma.trip.payment.weixin.web;
...
import com.moma.trip.weixin.oauth.Pay;
import com.moma.trip.weixin.po.WeChatBuyPost;
import com.moma.trip.weixin.util.MenuUtil;
import com.moma.trip.weixin.util.Tools;
import com.moma.trip.weixin.util.WeChatUtil;
...
public class PayNotifyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			WeChatUtil.message.sendText(accessToken, orderId, "您的订单号" + orderId + "已经支付成功！");
			//发货通知！推荐支付成功后就发送此通知...
