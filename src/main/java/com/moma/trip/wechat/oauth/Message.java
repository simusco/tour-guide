 ...
 */
package com.moma.trip.wechat.oauth;
...
import com.moma.trip.wechat.util.HttpKit;
import com.moma.trip.wechat.util.MsgTypes;
...
public class Message {
     ...
     * @throws IOException
     */
    public JSONObject massSendall(String accessToken, MsgTypes type, String content, String title, String description, String groupId, String[] openids, boolean toAll) throws InterruptedException, ExecutionException, IOException {
        Map<String, Object> json = new HashMap<String, Object>();
