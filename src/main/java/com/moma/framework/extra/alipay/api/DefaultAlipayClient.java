...
import com.moma.framework.extra.taobao.api.FileItem;
import com.moma.framework.extra.taobao.api.TaobaoParser;
import com.moma.framework.extra.taobao.api.TaobaoRequest;
import com.moma.framework.extra.taobao.api.TaobaoResponse;
import com.moma.framework.extra.taobao.api.TaobaoUploadRequest;
import com.moma.framework.extra.taobao.api.internal.parser.json.ObjectJsonParser;
import com.moma.framework.extra.taobao.api.internal.parser.xml.ObjectXmlParser;
import com.moma.framework.extra.taobao.api.internal.util.RequestParametersHolder;
import com.moma.framework.extra.taobao.api.internal.util.TaobaoHashMap;
import com.moma.framework.extra.taobao.api.internal.util.TaobaoLogger;
import com.moma.framework.extra.taobao.api.internal.util.TaobaoUtils;
...
public class DefaultAlipayClient implements AlipayClient {
	...
	public <T extends TaobaoResponse> RequestParametersHolder doPost(TaobaoRequest<T> request, String accessToken, String version) throws AlipayApiException {
		...
		if (AlipayConstants.SIGN_TYPE_RSA.equals(this.sign_type)) {
			...
			protocalMustParams.put(AlipayConstants.SIGN, AlipaySignature.rsaSign(signContent, privateKey, Constants.CHARSET_UTF8));
		} else {
		...
		try {
			if (request instanceof TaobaoUploadRequest) {
				...
				rsp = WebUtils.doPost(requestUrl.toString(), appParams, fileParams, connectTimeout, readTimeout);
			} else {
				rsp = WebUtils.doPost(requestUrl.toString(), appParams, connectTimeout, readTimeout);
			}
