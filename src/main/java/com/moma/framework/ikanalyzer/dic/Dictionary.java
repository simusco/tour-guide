 ...
 * 
 */
package com.moma.framework.ikanalyzer.dic;
...
import com.moma.framework.ikanalyzer.cfg.Configuration;
...
public class Dictionary {
	 ...
	 * 分词器默认字典路径 
	 */
	public static final String PATH_DIC_MAIN = "/ikanalyzer/dic/main.dic";
	public static final String PATH_DIC_SURNAME = "/ikanalyzer/dic/surname.dic";
	public static final String PATH_DIC_QUANTIFIER = "/ikanalyzer/dic/quantifier.dic";
	public static final String PATH_DIC_SUFFIX = "/ikanalyzer/dic/suffix.dic";
	public static final String PATH_DIC_PREP = "/ikanalyzer/dic/preposition.dic";
	public static final String PATH_DIC_STOP = "/ikanalyzer/dic/stopword.dic";
