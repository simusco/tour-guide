...
<link rel="stylesheet" href="${staticServerPath1 }/styles/pages/favorite.css">
        ...
        <div class="rightbody__grid">
        	<c:forEach items="${favorites }" var="favorite" varStatus="x">
            	...
            	<div class="profile-grid mtl">
		            ...
		            <div class="favorite profile-grid__span-1${x.count % 3 == 0 ? '--last' : '' }">
		                <div class="favorite__img">
		                    <div class="thumbnail">
		                        <img class="thumbnail__img" src="${staticServerPath1 }/images/${favorite.imageURL }" alt="">
		                        <p class="thumbnail__name"><span>${favorite.name }</span></p>
		                    </div>
		                </div>
		                <div class="favorite__toobar">
		                    ...
		                    <a href="<%=request.getContextPath()  %>/web/v1/activity/detail.html?type=HOT&routeId=${favorite.activityId}" class="btn-detail">查看详情>></a>
		                </div>
		            </div>
